...
public class JDlgLivroPesquisarNcc extends javax.swing.JDialog {
     ...
     */
    public JDlgLivroPesquisarNcc(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDlgLivroPesquisarNcc.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDlgLivroPesquisarNcc dialog = new JDlgLivroPesquisarNcc(new javax.swing.JFrame(), true);
