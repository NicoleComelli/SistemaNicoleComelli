...
public class JDlgVendedorPesquisarNcc extends javax.swing.JDialog {
     ...
     */
    public JDlgVendedorPesquisarNcc(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDlgVendedorPesquisarNcc.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDlgVendedorPesquisarNcc dialog = new JDlgVendedorPesquisarNcc(new javax.swing.JFrame(), true);
