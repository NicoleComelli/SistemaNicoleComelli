...
public class JDlgConsultaUsuarioNcc extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDlgConsultaUsuarioNcc.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDlgConsultaUsuarioNcc dialog = new JDlgConsultaUsuarioNcc(new javax.swing.JFrame(), true);
