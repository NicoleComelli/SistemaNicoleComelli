...
public class JDlgAutorPesquisar extends javax.swing.JDialog {
     ...
     */
    public JDlgAutorPesquisar(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDlgAutorPesquisar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDlgAutorPesquisar dialog = new JDlgAutorPesquisar(new javax.swing.JFrame(), true);
